...
#DEFINE MAXVALORC  010   // //Multitek                                // Máximo de caracteres por linha de valores numéricos
...
lImpSimp := ( !Empty( MV_PAR06 ) .and. MV_PAR06 == 1 )
	lImpSimp := .f. //  Nao e para ser usada na Multitek  Forca sempre falso. MULTITEK
